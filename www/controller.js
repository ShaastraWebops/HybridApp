...
var module = angular.module('app', ['onsen','ngAnimate','LocalStorageModule','ngSanitize','ngCookies']);
...
module.config(function ($httpProvider) {
 ...
 module.factory('authInterceptor', function ($rootScope, $q, $cookieStore, $location) {
    return {
...
module.controller('MyCtrl', ['$scope', '$http', '$sce',
  ...
  $scope.groups[1] = {
   ...
   $scope.groups[3] = {
    ...
    $scope.groups[3].items.push("<div style=\"text-align:left;\"><b>· Anirudh Sharma</b><br><b>· Subbarao Aynampudi</b><br><b>· Pavan Kumar</b><br><b>· Vaibhav Chhabra</b><br><b>· Meghna Bhutoria</b><br><b>· Abhinav Das</b><br>Check out our <a href = \"http://shaastra.org/#/maker-summit\">website</a> for more details on the speakers!</div>");
   ...
   $scope.groups[4] = {
    ...
    $scope.groups[5].items.push("<b>Day 1</b><br><b>10am - 12pm: Panel Discussion - From Backyards to Makerspaces:</b> The rise of the Maker Culture<br><b>12pm - 3pm: </b>Networking Lunch<br><b>3pm - 5pm: Workshop Session 1 - </b>Laser cutting / 3D printing<br><b>Mentoring session 1: Problem Identification and Ground survey - </b>Interact with people, crack your heads and rack your brains to identify a problem that is worth solving. Points will be awarded for relatability to the track, the depth and number of inputs considered<br><br><b>Day 2</b><br><b>10am - 12pm: Workshop Session 2 - </b>Laser cutting / 3D printing<br><b>2pm - 4pm:</b> Talk by Anirudh Sharma, MIT Media Labs<br><b>Mentoring session 2: Solution Ideation - </b>Time to brainstorm and apply your <b>maker</b> skills to come up with a cool and classy solution to your problem with the limited resources available. Brownies to feasible and creative solutions<br><br><b>Day 3</b><br><b>Mentoring session 3: Prototype Definition - </b>Go ahead and start giving shape to your prototype.We need to see something up and running. Fastest Fingers First!<br><br><b>Day 4</b><br><b>10am - 12pm:</b> Presentation and prize distribution ceremony<br><b>Product Launch - </b>Time to show the world what 4 sleepless nights and 5 insanely crazy and talented makers can achieve. The Maker Summit provides an opportunity for you to display your projects to thousands of students<br>");
